...
const TaskEndModal: React.FC<TaskEndModalProps> = ({ isOpen, onClose }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-[#F5F5F5] rounded-lg p-8 w-[470px] max-h-[80vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-[25px] text-[#5E5E5E]">タスク完了</h2>
        </div>
        ...
        <form className="space-y-6 text-[15px]">
          ...
          <div className="flex justify-center text-[#707070]">
            タスクが正常に完了しました。成果物が登録されました。
          </div>
