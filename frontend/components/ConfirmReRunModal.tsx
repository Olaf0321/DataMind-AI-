...
const ConfirmReRunModal: React.FC<ConfirmReRunModalProps> = ({ isOpen, onClose, onConfirm }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-[#F5F5F5] rounded-lg p-8 w-[470px] max-h-[80vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-[25px] text-[#5E5E5E]">再実行確認</h2>
        </div>
...
export default ConfirmReRunModal;
